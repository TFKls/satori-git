...
class Dispatch(Object):
    ...
    @Argument('argument', "the index or name of the argument to dispatch on",
              type=(int, str))
...
class Implement(Object):
    ...
    @Argument('type', "the argument type(s) handled by this implementation",
              type=(TypeType, TupleType))
    def __init__(self, type):                                  # pylint: disable-msg=W0622
