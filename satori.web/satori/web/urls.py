...
#    url(r'news/(?P<id>\d+)/delete$', 'satori.web.views.contest.news.delete', name='contest_news_delete'),
    ...
    url(r'cribsresults$', 'satori.web.views.contest.cribsresults.view', name='cribsresults'),
    url(r'showcribs$', 'satori.web.views.contest.showcribs.view', name='showcribs'),
...
#    url(r'subpage/(?P<id>\d+)/delete$', 'satori.web.views.contest.subpage.delete', name='contest_subpage_delete'),
    ...
    url(r'findcribs/diff$', 'satori.web.views.contest.viewfindcribs.diff', name='findcribs_diff'),
