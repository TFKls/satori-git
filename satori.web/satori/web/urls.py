...
#    url(r'news/(?P<id>\d+)/delete$', 'satori.web.views.contest.news.delete', name='contest_news_delete'),
    ...
    url(r'extends', 'satori.web.views.contest.extends.view', name='extends'),
    url(r'print', 'satori.web.views.contest.print.view', name='print'),
...
#    url(r'^test$', 'satori.web.views.test.view', name='test'),
    ...
    url(r'^configuration/psgrant$', 'satori.web.views.configuration.problemsetter_grant', name='problemsetter_grant'),
    url(r'^configuration/page_delete$', 'satori.web.views.configuration.pagedelete', name='subpage_delete'),
    url(r'^configuration/psrevoke$', 'satori.web.views.configuration.problemsetter_revoke', name='problemsetter_revoke'),
...
#    url(r'^news/(?P<id>\d+)/delete$', 'satori.web.views.news.delete', name='news_delete'),
    ...
    url(r'^profile/(?P<id>\d+)$', 'satori.web.views.profile.view', name='profile'),
    ...
    url(r'^subpage/(?P<id>\d+)/delete$', 'satori.web.views.configuration.pagedelete', name='subpage_delete_old'),
