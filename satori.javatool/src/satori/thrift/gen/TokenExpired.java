...
public class TokenExpired extends Exception implements TBase<TokenExpired, TokenExpired._Fields>, java.io.Serializable, Cloneable {
  private static final TStruct STRUCT_DESC = new TStruct("TokenExpired");
  ...
  static {
    ...
    FieldMetaData.addStructMetaDataMap(TokenExpired.class, metaDataMap);
  }
  ...
  public TokenExpired setMessage(String message) {
    this.message = message;
    return this;
  }
