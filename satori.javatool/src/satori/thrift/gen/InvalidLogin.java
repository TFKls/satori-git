...
public class InvalidLogin extends Exception implements TBase<InvalidLogin, InvalidLogin._Fields>, java.io.Serializable, Cloneable {
  private static final TStruct STRUCT_DESC = new TStruct("InvalidLogin");
  ...
  static {
    ...
    FieldMetaData.addStructMetaDataMap(InvalidLogin.class, metaDataMap);
  }
   ...
   */
  public InvalidLogin(InvalidLogin other) {
  ...
  public InvalidLogin deepCopy() {
    return new InvalidLogin(this);
  }
  ...
  public InvalidLogin setMessage(String message) {
    this.message = message;
    return this;
  }
  ...
  public InvalidLogin setLogin(String login) {
    this.login = login;
    return this;
  }
  ...
  public InvalidLogin setReason(String reason) {
    this.reason = reason;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof InvalidLogin)
      return this.equals((InvalidLogin)that);
    return false;
  }

  public boolean equals(InvalidLogin that) {
    if (that == null)
      return false;
  ...
  public int compareTo(InvalidLogin other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    InvalidLogin typedOther = (InvalidLogin)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("InvalidLogin(");
    boolean first = true;
